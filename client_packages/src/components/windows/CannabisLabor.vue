            ...
            <div class="middle">
                <div id="anzeigen">
                    ...
                    <div class="anzeige" id="druck">
                        <span>UV Energy (<span class="roboto-font text-center percentage">{{ methData.pressure.current }}</span> Watt)</span>
                        <div class="progress-bar green glow">
                            <span :style="'width:' + getPercentagePressure + '%'"></span>
                        </div>
                    </div>
                    <div class="anzeige" id="rotate">
                        <span>Luftfeuchtigkeit (<span class="roboto-font text-center percentage">{{ methData.stirring.current }}</span> %)</span>
                        <div class="progress-bar green glow">
                            <span :style="'width:' + getPercentageStirring + '%'"></span>
                        </div>
                    </div>
                    <div class="anzeige" id="menge">
                        <span>Dünger (<span class="roboto-font text-center percentage">{{ methData.amount.current }}</span> Stck.)</span>
                        <div class="progress-bar green glow">
